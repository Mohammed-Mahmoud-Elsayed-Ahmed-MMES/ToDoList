...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function fetchItems(displayType = 'table') {
        fetch('/api/items/') // instead of http://127.0.0.1:8000/api/items/ because it can't get or show items from /api/items/ cause of 127.0.0.1:8000
    ...
    addItemForm.addEventListener("submit", function(e) {
        ...
        fetch('/api/items/', { // http://127.0.0.1:8000/api/items/
            method: "POST",
            headers: {
    ...
    function handleEdit(event) {
        ...
        fetch(`/api/items/${id}/`) // http://127.0.0.1:8000/api/items/
            .then(response => response.json())
            .then(data => {
...
//     console.log("DOM loaded, elements:", { itemsList, taskCards, tableContainer, cardContainer });

//     // Fetch and display items
//     function fetchItems(displayType = 'table') {
//         fetch('/api/items-list/') // instead of http://127.0.0.1:8000/api/items/ because it can't get or show items from /api/items/ cause of 127.0.0.1:8000
//             .then(response => {
...
//         fetch('/api/items-list/', { // http://127.0.0.1:8000/api/items/
//             method: "POST",
//             headers: {
//                 "Content-Type": "application/json",
//                 "X-CSRFToken": getCookie('csrftoken')  
...
//         fetch(`/api/items-list/${id}/`) // http://127.0.0.1:8000/api/items/ 
//             .then(response => response.json())
//             .then(data => {
//                 document.getElementById("edit-id").value = data.id;
//                 document.getElementById("edit-name").value = data.name;
